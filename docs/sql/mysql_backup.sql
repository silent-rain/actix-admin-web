...
VALUES
  ...
  (
    ...
    '/permission/user',
    '用户管理',
    '@/views/permission/user/index.vue',
    '',
    '',
    '',
    '',
  ...
  (
    ...
    '/permission/role',
    '角色管理',
    '@/views/permission/role/index.vue',
    '',
    '',
    '',
    '',
  ...
  (
    ...
    '/dataCenter/config',
    '全局配置管理',
    '@/views/data-center/config/index.vue',
    '',
    '',
    '',
    '',
  ...
  (
    ...
    '系统日志管理',
    '@/views/system/log/systemLog.vue',
    '',
    '',
    '',
    '',
  ...
  (
    ...
    '/user/profile',
    '个人资料',
    '@/views/user/profile/profile.vue',
    '',
    '',
    '',
    '',
  ...
  (
    ...
    '/system/websiteConfig',
    '网站配置管理',
    '@/views/system/website-config/index.vue',
    '',
    '',
    '',
    '',
  ...
  (
    ...
    '/system/userLogin',
    '登录管理',
    '@/views/system/userLogin/index.vue',
    '',
    '',
    '',
    '',
  ...
  (
    ...
    0,
    0,
    '/permission/userApiToken',
    'API令牌管理',
    '@/views/permission/user-api-token/index.vue',
    '',
    '',
    '',
    '',
  ...
  (
    ...
    '/apiAuth/apiHttp',
    'HTTP接口管理',
    '@/views/api-auth/api-http/index.vue',
    '',
    '',
    '',
    '',
...
--
-- Table structure for table `perm_menu_role_rel`
--
DROP TABLE IF EXISTS `perm_menu_role_rel`;
...
CREATE TABLE
  ...
  ) ENGINE = InnoDB AUTO_INCREMENT = 222 DEFAULT CHARSET = utf8mb4 COLLATE = utf8mb4_unicode_ci COMMENT = '菜单角色关联表';

/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Dumping data for table `perm_menu_role_rel`
--
LOCK TABLES `perm_menu_role_rel` WRITE;

/*!40000 ALTER TABLE `perm_menu_role_rel` DISABLE KEYS */;
...
/*!40000 ALTER TABLE `perm_menu_role_rel` ENABLE KEYS */;
...
VALUES
  (
    ...
    'xxx',
    'xxx',
    'bff02e400c92372ce6d60596de5d8dd5',
    0,
    0,
    '2023-01-14 13:37:42',
    '2023-02-02 23:03:31'
  ...
  (
    ...
    19,
    '2023-02-06',
    '/upload/avatar/3a060ce93613cf2bb2cd961ddd33d0ca.gif',
    '18312465088',
    'xx23x@163.com',
  ...
  (
    ...
    1,
    '2023-02-14',
    '/upload/avatar/0ba837dd16e6895037a2a3f46c53098f.gif',
    '18312465168',
    'xxx@163.com',
    'cs',
    'saddas',
  ...
  (
    ...
    3,
    '2023-02-16',
    '/upload/avatar/29b4daa0ab7ec88bec276e23c6db3a0f.gif',
    '22222255555',
    '',
    '',
    '',
  ...
  (
    ...
    '',
    '',
    '963ad6725d046bc76d4a72c6a7444f28',
    0,
    1,
    '2023-02-06 23:21:03',
    '2023-02-06 23:21:03'
  ...
  (
    ...
    '',
    '',
    '7d4bff9d2194a9e3c53be923fd5ff21c',
    1,
    1,
    '2023-02-06 23:34:48',
    '2023-02-22 20:26:22'
...
VALUES
  (
    4,
    32,
    'bf07b991433d2d835472f44078b356bc',
    '手打',
    'POST',
    '',
    1,
  ...
  (
    5,
    20,
    '96f4705255f8a21e614f2a17cf76a27e',
    'xxx',
    'GET;POST;DELETE;PUT',
    'xx',
    1,
...
VALUES
  ...
  (
    ...
    '网站LOGO',
    'website_logo',
    '/upload/images/2023-02-26/c3c9bfd0153679db77deec116aad3aa8.ico',
    1,
    '',
    1,
    '2023-02-25 20:50:14',
  ...
  (
    ...
    '网站SEO描述',
    'website_seo_desc',
    '基于Go语言Gin、Vue、MySQL等框架打造的组件式敏捷开发框架，简化开发，提升开发效率！！',
    1,
    '',
    1,
    '2023-02-25 20:51:38',
  ...
  (
    ...
    '网站宣传片',
    'website_propaganda',
    '[{\"name\":\"合约.png\",\"url\":\"/upload/images/2023-02-26/69aa018dd7a362e0db00cdd51bc3e7d0.png\"},{\"name\":\"f778738c-e4f8-4870-b634-56703b4acafe.gif\",\"url\":\"/upload/images/2023-02-26/46ba34c2b7de1729b5f7ba9b80ab6794.gif\"}]',
    1,
    '',
    1,
    '2023-02-25 21:06:14',
  ...
  (
    ...
    '网站开发者',
    'website_anthor',
    'silent-rain,silent_rains@163.com',
    1,
    '',
    1,
    '2023-03-08 23:26:12',
