...
SET
    = utf8mb4 COLLATE = utf8mb4_unicode_ci COMMENT '用户登录日志表';
...
SET
    = utf8mb4 COLLATE = utf8mb4_unicode_ci COMMENT 'API操作日志表';
...
SET
    = utf8mb4 COLLATE = utf8mb4_unicode_ci COMMENT 'WEB日志表';