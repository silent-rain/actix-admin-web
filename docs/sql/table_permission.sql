-- 创建数据库 
CREATE DATABASE `actix_admin_web` DEFAULT CHARACTER
SET
...
SET
    = utf8mb4 COLLATE = utf8mb4_unicode_ci COMMENT '角色表';
...
SET
    = utf8mb4 COLLATE = utf8mb4_unicode_ci COMMENT '用户';
...
SET
    = utf8mb4 COLLATE = utf8mb4_unicode_ci COMMENT '用户角色关联表';
...
SET
    = utf8mb4 COLLATE = utf8mb4_unicode_ci COMMENT '菜单表';
...
SET
    = utf8mb4 COLLATE = utf8mb4_unicode_ci COMMENT '菜单角色关联表';
...
SET
    = utf8mb4 COLLATE = utf8mb4_unicode_ci COMMENT '用户Token令牌表, 一般openapi服务';
...
SET
    = utf8mb4 COLLATE = utf8mb4_unicode_ci COMMENT '用户地理位置';
...
SET
    = utf8mb4 COLLATE = utf8mb4_unicode_ci COMMENT '用户头像';
...
CREATE TABLE
    perm_dept (
        ...
        SET
            utf8mb4 COLLATE utf8mb4_0900_ai_ci DEFAULT NULL COMMENT '所有上级部门ID, 用逗号分开',
...
SET
    = utf8mb4 COLLATE = utf8mb4_unicode_ci COMMENT '部门表';
...
SET
    = utf8mb4 COLLATE = utf8mb4_unicode_ci COMMENT '部门角色关联表-数据权限';