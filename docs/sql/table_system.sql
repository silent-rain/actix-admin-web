...
SET
    = utf8mb4 COLLATE = utf8mb4_unicode_ci COMMENT '验证码表';
...
SET
    = utf8mb4 COLLATE = utf8mb4_unicode_ci COMMENT '配置表';
...
SET
    = utf8mb4 COLLATE = utf8mb4_unicode_ci COMMENT 'ICON图标表';
...
SET
    = utf8mb4 COLLATE = utf8mb4_unicode_ci COMMENT '字典维度表';
...
SET
    = utf8mb4 COLLATE = utf8mb4_unicode_ci COMMENT '字典数据表';